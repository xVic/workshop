...
Under the `$CHE_PROJECTS_ROOT/quarkus-workshop-super-heroes/super-heroes` root directory where you have all your code.
...
[source,properties]
----
include::{github-raw}/super-heroes/rest-fight/src/main/resources/application.properties[tags=!adocCORS;!adocRestClient;!adocOpenShiftRestClient;!adocKafka;!adocBanner]
----
